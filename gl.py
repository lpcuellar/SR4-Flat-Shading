...
class Render(object):
    ...
    def loadModel(self, filename, translate, scale, is_wireframe):
        ...
        for face in model.faces :
            ...
            if is_wireframe:
                ...
                if intensity >= 0 :
                    self.current_color = color(intensity, intensity, intensity)
                    self.triangle_barycentric_coordinates(v0, v1, v2, intensity)
                ...
                if count_vertices > 3 :
                    ...
                    if intensity >= 0 :
                        self.current_color = color(intensity, intensity, intensity)
                        self.triangle_barycentric_coordinates(v0, v2, v3, intensity)
    ...
    def triangle_barycentric_coordinates(self, a, b, c, intensity):
        ## definding the box limits
